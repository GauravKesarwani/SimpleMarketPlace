...
function validatefrmSignup(){
	...
	alert(document.getElementById('firstname').innerText);
	alert(document.getElementById('lastname').innerText);
	alert(document.getElementById('erruserid').innerText);
	alert(document.getElementById('passwd').innerText);
	alert(document.getElementById('confirmPasswd').innerText);
	alert(document.getElementById('errfirstname').innerText);
	alert(document.getElementById('errlastname').innerText);
	alert(document.getElementById('errpasswd').innerText);
	alert(document.getElementById('errconfirmPasswd').innerText);
	alert(document.getElementById('erremail').innerText);
